...
* `log_encryption_kms_key_id` - (Optional) The AWS KMS master key ID or arn used for encrypting log files. This attribute is only available with EMR version 5.30.0 and later, excluding EMR 6.0.0.  
